    ...
    <div data-sidebar className="flex flex-col h-full bg-surface border-r border-border-subtle">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            onClick={toggleCollapsed}
            className="hidden sm:flex p-1.5 rounded-lg hover:bg-inset transition-colors"
          ...
          <button
            onClick={onClose}
            className="p-1 rounded hover:bg-inset sm:hidden transition-colors"
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      ...
      <div className="px-3 py-2">
        <div className="relative">
          <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-fg-tertiary pointer-events-none" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-1.5 text-sm bg-inset rounded-xl border-0 outline-none focus:ring-1 focus:ring-brand placeholder:text-fg-tertiary transition-shadow"
          />
        </div>
      </div>
        ...
        {!localQuery && (
          <div className="mt-2 pt-2 border-t border-border-subtle">
            <button
              ...
              className="flex items-center gap-2 w-full px-3 py-2 text-xs font-medium text-fg-muted hover:text-fg rounded-lg hover:bg-inset transition-colors"
            >
