...
| # | Фича | Как тестировать | Роль | Статус | Баг / Заметка |
|---|---|---|---|---|---|
| 4.1 | Поиск по продуктам | "Какие тарифы есть?" | Seller | ⬜ | |
| 4.2 | Поиск по компании | "Сколько учеников у EdPalm?" | Seller | ⬜ | |
| 4.3 | Поиск по аттестации | "Как проходит аттестация?" | Seller | ⬜ | |
| 4.4 | Поиск по зачислению | "Как начать учиться?" | Seller | ⬜ | |
| 4.5 | FAQ support | "Как получить справку?" | Support | ⬜ | |
| 4.6 | Нет ответа в KB | Вопрос вне темы → guardrails | Все | ⬜ | |
| 4.7 | Namespace изоляция | Seller не видит support KB и наоборот | Все | ⬜ | |
| 4.8 | Tool status UI | При поиске — "Ищу в базе знаний..." | Все | ⬜ | |
